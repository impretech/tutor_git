...
export class SubmittalsList {
    ...
    private init(): void {
        this.setupGrids();
        this.NewVendorButton = document.querySelector("#new-submittal-button") as HTMLButtonElement;
    ...
    private testInsertSubmittal(): void {
        let sub = {} as any;
        sub.projectID = 1001;
    ...
    private SubGridSelectionChanged = (arg: kendo.ui.GridChangeEvent): void => {
...
export class SubmittalDetailsItem {
    ...
    private DistributonExpandButton: HTMLSpanElement;
    private DistributonReduceButton: HTMLSpanElement;
    ...
    private init(): void {
        ...
        this.DistributonExpandButton = document.querySelector(".dist-expand-btn") as HTMLSpanElement;
    ...
    private BuildDistributionLogsGrid() {
        ...
        let distAddButton = document.querySelector("#distribution-add-button") as HTMLLinkElement;
    ...
    private BuildAttachments() {
        ...
        let recAttachAddButton = document.querySelector("#rec-attach-add-button") as HTMLButtonElement;
        ...
        let descAttachAddButton = document.querySelector("#desc-attach-add-button") as HTMLButtonElement;
