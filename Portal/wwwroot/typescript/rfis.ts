...
export class RFIsList {
    ...
    private data: any;
    private NewRFIButton: HTMLButtonElement;
    ...
    private init(): void {
        this.setupGrids();
        this.TestDocCards();
        this.NewRFIButton = document.querySelector("#new-rfi-button") as HTMLButtonElement;
    ...
    private RFIGridSelectionChanged = (arg: kendo.ui.GridChangeEvent): void => {
...
export class RFIDetailsItem {
    ...
    private id: number;
    private max: number;
    private pom: number = 0;
    private typeValue: any[] = [];
    private user: any;
    private UploadDocButton: HTMLDivElement;
    private docUpload: DocUploadModal;
    private pm: string = 'Message';
    private SaveButton: HTMLButtonElement;
    private CancelButton: HTMLButtonElement;
    private ResponseExpandButton: HTMLSpanElement;
    private ResponseReduceButton: HTMLSpanElement;
    ...
    private async init(): Promise<void> {
        ...
        this.ResponseExpandButton = document.querySelector(".response-expand-btn") as HTMLSpanElement;
        ...
        this.ResponseReduceButton = document.querySelector(".response-reduce-btn") as HTMLSpanElement;
...
//                response.companyCode = kendoWindow.find("#add-from-company").val();
        ...
        let responseAddButton = document.querySelector("#response-add-button") as HTMLLinkElement;
...
<i class="fa fa-paperclip paperclip res-attach-add-button" id="response-attach-add-button${this.id}" aria-hidden="true"></i>
                ...
                let sendBtn = document.querySelector("#sendBtn" + this.id) as HTMLButtonElement;
                ...
                let responseAttachAddButton = document.querySelector("#response-attach-add-button" + this.id) as HTMLButtonElement;
                ...
                let helper2 = document.querySelector("#has-scheduleRfi" + this.id) as HTMLInputElement;
...
<div class="form-element firstRow" style="flex: 1 !important;">
		...
		<div class="form-element" style="flex: 3;">
            ...
            let sendBtn = document.querySelector("#sendBtn") as HTMLButtonElement;
            sendBtn.addEventListener("click", async (evt) => {
                this.isValid1 = true;
	...
	<div class="row" style="border-bottom:1px solid #ccc;">
		...
		<div class="form-element" style="flex: 3;">
            ...
            let helper = document.querySelector("#has-scheduleRfi"+item.messageID) as HTMLInputElement;
            ...
            let helperOne = document.querySelector("#has-scheduleRfi-0") as HTMLInputElement;
    ...
    private LoadEmailsGrid(data) {
        ...
        $("#emails-grid").kendoGrid({
            ...
            this.getDocUrl(dataItem.docID as number, e);

            e.preventDefault();
        });
    }

    private async getDocUrl(docId: any, evt: any) {
...
//                        response.fromName = userResponse.data.userName;
    ...
    private async BuildAttachments() {
        ...
        let questionAttachAddButton = document.querySelector("#question-attach-add-button") as HTMLAnchorElement;
...
//                item.rfiDocLinkID = "response_tabstrip${item.rfiResponseID}";
    ...
    private async showDocWindow(docId: any,evt: any) {
