...
export class ProjectScheduleBar {

    private parentElement: HTMLDivElement;
    private progressBar: HTMLDivElement;
    private ganttBar: HTMLDivElement;
    private button: HTMLDivElement;
    private popOut: HTMLDivElement;

    private ScheduleProgressBar: HTMLDivElement;
    ...
    private init(): void {
        ...
        this.progressBar.appendChild(innerBorder);

        this.ScheduleProgressBar = document.createElement('div');
        this.ScheduleProgressBar.className = 'schedule-progress';
        this.progressBar.appendChild(this.ScheduleProgressBar);
    ...
    private createClickListener = (event) => {
    ...
    public Load(data: any): void {
        this.ScheduleProgressBar.innerHTML = "67.25%";
        this.ScheduleProgressBar.style.width = "calc(" + 67.25 + "% - 5px)";
