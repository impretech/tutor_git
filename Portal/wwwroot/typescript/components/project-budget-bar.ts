...
export class ProjectBudgetBar {
    ...
    private TotalBudgetBar: HTMLDivElement;
    private PendingPOBar: HTMLDivElement;
    private CommittedPOBar: HTMLDivElement;
    private InvoiceTotalBar: HTMLDivElement;
    private InvoicePaidBar: HTMLDivElement;
