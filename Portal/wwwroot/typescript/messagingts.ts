...
export class MessagingList {
    ...
    private async BuildAttachments() {
       ...
       /* $("#question_tabstrip").kendoTabStrip({
        ...
        let questionAttachAddButton = document.querySelector("#new-message") as HTMLInputElement;
        questionAttachAddButton.addEventListener("click", async (evt) => {
            ...
            if ($("#hdnbtn").val() == 'Project') {
                ...
                let typeAction = document.querySelector("#message-type") as HTMLSelectElement;
            ...
            let helper = document.querySelector("#has-schedule") as HTMLInputElement;
            ...
            let upl = document.querySelector("#addDocumentReply") as HTMLAnchorElement;
        ...
        let msg = document.querySelector("#new-message-btn") as HTMLInputElement;
        ...
        this.data.projectMessages.forEach((item, index) => {
            ...
            let replyMsg = document.querySelector("#replyMessage-" + item.id) as HTMLInputElement;
            replyMsg.addEventListener("click", async (evt) => {
                ...
                let tmp1 = document.querySelector("#new-message-reply-" + item.id) as HTMLInputElement;
                ...
                let uploadDoc = document.querySelector("#addDocumentReply-" + item.id) as HTMLAnchorElement;
                ...
                if ($("#hdnbtn").val() == 'Project') {
                    let typeAction = document.querySelector("#message-type-reply-" + item.id) as HTMLSelectElement;
                    typeAction.addEventListener("change", async (evt) => {
                ...
                $("#new-message-reply-" + item.id).removeClass("error");
                $("#new-message").removeClass("error");
                let msg = document.querySelector("#new-message-btn-reply-"+item.id) as HTMLInputElement;
                msg.addEventListener("click", async (evt) => {
    ...
    private async InitializeMessageEventsParam(id) {
    ...
    private async InitializeMessageEvents() {
