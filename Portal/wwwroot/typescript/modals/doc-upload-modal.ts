...
export class DocUploadModal {
    ...
    public Show(projectid, entcode, itemtype, itemid) {
        this.modal.Show();
    ...
    public ShowForSubmittal(submittalID, type, projectid, entcode) {
        this.modal.Show();
        $("#files").kendoUpload({
            async: {
                saveUrl: "/upload/saveAsync",
    ...
    private InsertSubDocLink(uid, submittalID, type) {
        let subdocData = {} as any;
    ...
    public ShowForRFI(rfI_ID, type, responseid, projectid, entcode) {
    ...
    public InsertRFIDocLink(uid, rfI_ID, type, responseid) {
        let rfidocData = {} as any;
    ...
    public ShowForQuote(itemID, itemType,  projectID, quoteID, entcode) {
    ...
    public InsertQuoteDocLink(DocID, itemID, itemType) {
...
//                console.log('quotedocInsert', res);
    ...
    public ShowForOther(type, messageid, projectid, entcode, element1) {
        this.modal = new Modal();
    ...
    public InsertMessageDocLink(uid, messageid, type, element ) {
        let docData = {} as any;
