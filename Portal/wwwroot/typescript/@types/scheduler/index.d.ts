...
interface SchedulerTemplates {
    month_timeline_cell_class: (evs: any, date: any, section: any) => "dhx_cell_holiday" | "";
    two_week_timeline_cell_class: (evs: any, date: any, section: any) => "dhx_cell_holiday" | "";
    week_timeline_cell_class: (evs: any, date: any, section: any) => "dhx_cell_holiday" | "";
    month_timeline_scale_label: (key: any, label: any, section: any) => string;
    two_week_timeline_scale_label: (key: any, label: any, section: any) => string;
    week_timeline_scale_label: (key: any, label: any, section: any) => string;
    month_timeline_scale_date: (date: any) => string;
    two_week_timeline_scale_date: (date: any) => string;
    week_timeline_scale_date: (date: any) => string;
	/**
...
interface SchedulerDateHelpers {
    add_month_timeline: (date: any, inc: any) => Date;
    month_timeline_start: (origin: Date) => Date;
    two_week_timeline_start: (origin: Date) => Date;
    week_timeline_start: (origin: Date) => Date;
...
interface SchedulerLocaleLabels {
    month_timeline_tab: string;
    two_week_timeline_tab: string;
    week_timeline_tab: string;
...
declare interface Window { dataProcessor: any }
