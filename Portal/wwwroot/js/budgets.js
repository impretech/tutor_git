...
export class BudgetsList {
    constructor(data) {
        this.BudgetGridSelectionChanged = (arg) => {
...
export class BudgetDetailsItem {
    ...
    async init() {
        ...
        this.AvlCommitButton = document.querySelector("#avl-commit-btn");
        ...
        this.AvlPndButton = document.querySelector("#avl-pnd-btn");
        ...
        this.DateOpenButton = document.querySelector("#date-open-btn");
        ...
        this.DatePblButton = document.querySelector("#date-pub-btn");
    ...
    LoadKendoWindow() {
        ...
        contKendoWindow
            ...
            .end();
        let contributorAddButton = document.querySelector("#cont-add-btn");
    ...
    RedrawDetailRow(budDetail, offset) {
    ...
    DeleteDetailRow(budDetail, offset) {
        $(".detail-pane .detail-data .detail-row").each((i, obj) => {
            let detailid = $(obj).attr('detailid'); //depositDetailID
            if (detailid == budDetail.budgetDetailID) {
                let table = $(obj).closest("table");
    ...
    InsertDetailRow(budDetail, offset) {
    ...
    DrawDetails(categories, details) {
