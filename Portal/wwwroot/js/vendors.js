...
export class VendorsList {
    constructor(data) {
        this.VendorGridSelectionChanged = (arg) => {
    ...
    init() {
        this.setupGrids();
        this.NewVendorButton = document.querySelector("#new-vendor-button");
...
export class VendorDetailsItem {
    ...
    init() {
        ...
        this.SaveButton.addEventListener("click", async (evt) => {
            ...
            let unionCheckbox = document.querySelector("#isunion");
    ...
    BuildVendorContactCards(vcontacts) {
