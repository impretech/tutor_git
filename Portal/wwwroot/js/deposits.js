...
export class DepositsList {
    ...
    init() {
        this.setupGrids();
        this.NewContactButton = document.querySelector("#new-contact-button");
...
export class DepositDetailsItem {
    ...
    async init() {
        ...
        this.DepositButton = document.querySelector("#save-button");
    ...
    async LoadContactsAndProjectsAndDeposits() {
    ...
    // Draw Categires
    DrawCategoriesAndChart(categories) {
        $(".categories").html("");
        let total_budget = 0;
    ...
    RedrawDetailRow(budDetail, old_deposit) {
    ...
    // Draw Budget Details
    DrawDetailsTable(categories, details) {
        $(".detail-pane .detail-data").html("");
