...
export class QuoteDetailsItem {
    ...
    LoadAddAddendumKendoWindow() {
        ...
        adKendoWindow
            ...
            .end();
        let addendumAddButton = document.querySelector("#addendum-add-btn");
        if (this.data.quote.quoteID == 0) {
    ...
    DocInsertHandler() {
        ...
        window.addEventListener('quotedocinsert', async (e) => {
    ...
    async LoadProjectsAndVendorsAndDocuments() {
        if (this.data.quote.quoteID == 0)
