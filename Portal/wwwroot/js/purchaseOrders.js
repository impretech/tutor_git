...
export class PurchaseOrdersList {
    constructor(data) {
        this.PurchaseGridSelectionChanged = (arg) => {
    ...
    init() {
        this.setupGrids();
        this.NewPOButton = document.querySelector("#new-purchaseOrder-button");
...
export class PurchaseOrdersDetailItem {
    ...
    async init_DataSources() {
        ...
        this.projectDataSource = async (entCode) => {
    ...
    async DrawExtDetails() {
        ...
        extPoGroup.forEach((group, index) => {
            ...
            let content = `<div class="extPoGroup" poGroupID="${extPoGroup[index].poGroupID}">
    ...
    async updateExtDetailRow(e, type = 0) {
    ...
    async updateDetailRow(e, type = 0) {
    ...
    DeleteDetailRow(lineItemDetail, offset) {
    ...
    async InsertDetailRow(budDetail) {
        $(".detail-pane .detail-data").html("");
        var detailSubTotal = 0;
        var selectCode = "";
        var codeTootip = "";
    ...
    RenderButtons() {
        //Init Tables
        this.GeneralViewButton = document.querySelector("#general-view-btn");
        ...
        this.DetailViewButton = document.querySelector("#detail-view-btn");
        ...
        this.FundingSumaryDetailButton = document.querySelector("#funding-detail-btn");
        ...
        this.QuoteDetailButton = document.querySelector("#quote-detail-btn");
        ...
        this.PublishButton = document.querySelector("#save-button");
        ...
        this.CreateExtensionButton = document.querySelector("#newExt-button");
    ...
    async init_newLineItem(lineItem) {
        var codes = await this.poLineItmDataSource(this.model.po.projectID);
        var categoryList = codes.reduce(function (memo, e1) {
            var matches = memo.filter(function (e2) {
                return e1.category == e2.category;
