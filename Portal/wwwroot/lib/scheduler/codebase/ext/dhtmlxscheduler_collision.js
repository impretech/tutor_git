...
var i=e._get_section_property();return t[i]==a[i]&&t.id!=a.id?!0:!1},e.checkCollision=function(t){var i=[],n=e.config.collision_limit;if(t.rec_type)for(var r=e.getRecDates(t),s=0;s<r.length;s++)for(var o=e.getEvents(r[s].start_date,r[s].end_date),d=0;d<o.length;d++)(o[d].event_pid||o[d].id)!=t.id&&i.push(o[d]);else{i=e.getEvents(t.start_date,t.end_date);for(var l=0;l<i.length;l++){var _=i[l];if(_.id==t.id||_.event_length&&[_.event_pid,_.event_length].join("#")==t.id){i.splice(l,1);break}}}var c=e._get_section_view(),h=e._get_section_property(),u=!0;
if(c){for(var g=0,l=0;l<i.length;l++)i[l].id!=t.id&&this._check_sections_collision(i[l],t)&&g++;g>=n&&(u=!1)}else i.length>=n&&(u=!1);if(!u){var v=!e.callEvent("onEventCollision",[t,i]);return v||(t[h]=a||t[h]),v}return u}}()});
